...
export const ImageCard = ({ id, title, url, publicId }: ImageType) => (
  ...
  >
    <Image
      ...
      height={300}
      loading="eager"
      className="aspect-video group-hover:scale-110 object-cover w-auto h-auto transition-all duration-400 rounded-md"
    />
    <div className="sm:translate-y-15 group-hover:translate-y-0 transition-all duration-400 absolute bottom-0 flex justify-between items-center w-full backdrop-blur-xs border-t border-t-primary/30 overflow-hidden px-4 py-2 rounded-b-md">
